			...
			howto: {
				"validate-go-cuego": {
					page: {
						cache: {
							upload: {
								"main.go": "zrL/BQmfsqbh7fF7ifNgFz/y4DGUGrn1NXrrjUO4WGs="
							}
							multi_step: {
								hash:       "87KLS4M0HIR9BEO45TIM0MH8DROTRM3GKNKDOVPJPHDBCIJV0ETG===="
								scriptHash: "NB0QHO039EB3SCDFAI01MKN5GFT0JRDDOEPSU2INBCTBKPGKOU3G===="
								steps: [{
									doc:      ""
